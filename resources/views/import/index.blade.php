        ...
        <div class="col-md-10">
            <div class="card shadow-lg rounded">
                <div class="card-header bg-primary text-white text-center">
                    <h3 style="background-color: lightgreen; padding: 5px; border-radius: 2px;">
                        <i class="fas fa-file-import"></i> Importation CSV
                    </h3>
                </div>
                <div class="card-body">
                    <div style="padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color: #f8f9fa;">
                        <form action="{{ route('import.upload') }}" method="POST" enctype="multipart/form-data" style="padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color: #ffffff;">
                            @csrf
                            <div class="form-group">
                                <label for="file" class="h5" style="display: block; margin-bottom: 5px;">
                                    <i class="fas fa-file-csv"></i> CSV Projets
                                </label>
                                <input type="file" class="form-control @error('file') is-invalid @enderror" id="file" name="file" required style="margin-bottom: 10px;">

                                <label for="file2" class="h5 mt-3" style="display: block; margin-top: 15px; margin-bottom: 5px;">
                                    <i class="fas fa-file-csv"></i> CSV Tâches
                                </label>
                                <input type="file" class="form-control @error('file2') is-invalid @enderror" id="file2" name="file2" required style="margin-bottom: 10px;">

                                <label for="file3" class="h5 mt-3" style="display: block; margin-top: 15px; margin-bottom: 5px;">
                                    <i class="fas fa-file-csv"></i> CSV Offres
                                </label>
                                <input type="file" class="form-control @error('file3') is-invalid @enderror" id="file3" name="file3" required style="margin-bottom: 10px;">
                            ...
                            <center>
                            <button type="submit" class="btn btn-primary btn-lg w-100 mt-3" style="margin-top: 15px;">
                                Importer
                            </button>
                            </center>
                        </form>
